...
namespace Radix.DatabaseManagement
{
    class SQLiteConnection
    {
        ...
        public SQLiteConnection(string path, string password, bool useUTF16, bool isLegacy, bool usePooling, bool isReadOnly, bool useTickAsDateTimeFormat, bool useGUIDasText, bool createOnMissing, bool keepJournal, int maxPageCount, int maxPoolSize, int cacheSize, int pageSize)
        {
            this._path = path;
